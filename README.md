...
A curated startup kit of agent skills and MCP references for Codex and other agentic IDEs.

This repo does not run anything by itself. It gives your agent installable skill paths, scenario bundles, and MCP config examples so a fresh agent setup can become useful quickly.
...
| Folder | Purpose |
| --- | --- |
| [`favourites/`](https://github.com/iice257/Skills/tree/main/favourites) | Max 5 highest-value skills for quick installs. |
| [`custom skills/`](https://github.com/iice257/Skills/tree/main/custom%20skills) | My profile/custom skills and other non-stock skills. |
...
These are profile/custom skills or non-stock additions. They are referenced from `custom skills/` and also included canonically in `all/`.

<details open>
<summary><strong>Custom/profile catalog</strong></summary>

| Skill | Use it when | Link |
| --- | --- | --- |
| `design-taste-frontend` | Premium frontend/product UI judgment. | [View](https://github.com/iice257/Skills/tree/main/custom%20skills/design-taste-frontend) |
| `redesign-existing-projects` | Upgrading existing UI without losing product direction. | [View](https://github.com/iice257/Skills/tree/main/custom%20skills/redesign-existing-projects) |
| `image-taste-frontend` | Image-first visual direction for frontend work. | [View](https://github.com/iice257/Skills/tree/main/custom%20skills/image-taste-frontend) |
| `gpt-taste` | High-end UX/UI and motion-heavy design direction. | [View](https://github.com/iice257/Skills/tree/main/custom%20skills/gpt-taste) |
| `industrial-brutalist-ui` | Brutalist, mechanical, high-contrast interface direction. | [View](https://github.com/iice257/Skills/tree/main/custom%20skills/industrial-brutalist-ui) |
| `minimalist-ui` | Clean editorial-style UI. | [View](https://github.com/iice257/Skills/tree/main/custom%20skills/minimalist-ui) |
| `high-end-visual-design` | Agency-grade polish, spacing, and visual quality. | [View](https://github.com/iice257/Skills/tree/main/custom%20skills/high-end-visual-design) |
| `stitch-design-taste` | Agent-friendly design systems for Google Stitch. | [View](https://github.com/iice257/Skills/tree/main/custom%20skills/stitch-design-taste) |
| `full-output-enforcement` | Complete output with no placeholders. | [View](https://github.com/iice257/Skills/tree/main/custom%20skills/full-output-enforcement) |
| `idea-launcher` | Turning rough ideas into buildable plans and starter projects. | [View](https://github.com/iice257/Skills/tree/main/custom%20skills/idea-launcher) |
| `imessage-handoff` | iMessage handoff for Codex threads. | [View](https://github.com/iice257/Skills/tree/main/custom%20skills/imessage-handoff) |
| `x-publisher` | Drafting, validating, and preparing X/Twitter posts. | [View](https://github.com/iice257/Skills/tree/main/custom%20skills/x-publisher) |
| `find-skills` | Finding useful agent skills for a task. | [View](https://github.com/iice257/Skills/tree/main/custom%20skills/find-skills) |
| `gemini-api-dev` | Gemini model and API development. | [View](https://github.com/iice257/Skills/tree/main/custom%20skills/gemini-api-dev) |

</details>

## All Skills

`all/` is the canonical install source. Skill folder names match the skill metadata names, so install paths and invocation names no longer fight each other.
...
- This is a curated collection. Some skills are custom/profile skills; some include third-party or open-source provenance in their own license files.
