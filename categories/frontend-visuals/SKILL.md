---
name: skill-starter-frontend-visuals
description: Install the Skill Starter Pack frontend visuals bundle by following this folder's paths.txt.
---

# Frontend Visuals Bundle

Use this when the user asks for image-led frontend work, landing pages, hero sections, or visual direction.
