---
name: skill-starter-mobile-desktop
description: Install the Skill Starter Pack mobile/desktop bundle by following this folder's paths.txt.
---

# Mobile Desktop Bundle

Use this when the user asks for desktop app, mobile-adjacent, WinUI, screenshots, or app workflow setup.
