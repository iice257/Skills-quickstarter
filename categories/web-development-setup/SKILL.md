---
name: skill-starter-web-development-setup
description: Install the Skill Starter Pack web development setup bundle by following this folder's paths.txt.
---

# Web Development Setup Bundle

Use this when the user asks for frontend, design, browser testing, GitHub CI, and deployment setup.
