---
name: skill-starter-reccomended
description: Install the Skill Starter Pack recommended all-round workflow bundle by following reccomended/paths.txt.
---

# Skill Starter Pack Reccomended

Use this when the user asks for the recommended all-round development workflow setup.
